      ...
      <div class="col-md-6">
        <div class="form-container">
          ...
          <div class="tab-content mt-4">
            <div id="signUp">
              <form method="POST" action="./auth_up.php">
                <div style="display: flex; flex-direction: column;">
                  <div class="form-row">
                    <div class="form-group">
                      <label for="prenom" class="input-label">Prénom:</label>
                      <input type="text" name='surname' class="form-control" id="prenom" aria-describedby="prenomHelp" placeholder="Prénom de l'étudiant" required>
                      <span id="SNerror-message"></span>
                    </div>
                    <div class="form-group">
                      <label for="nom" class="input-label">Nom:</label>
                      <input type="text" name='name' class="form-control" id="nom" aria-describedby="nomHelp" placeholder="Nom de l'étudiant" required>
                  ...
                  <div class="form-group">
                    <label for="inscri" class="input-label">Numéro d'inscription:</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="tel" name='phone' class="form-control" id="tel" aria-describedby="telHelp" placeholder="Numéro de téléphone">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name='password' class="form-control" id="passwordConfirm" placeholder="&#xf084; Confirmer votre mot de passe" required><br>
