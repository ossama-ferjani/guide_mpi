        ...
        <div class="col-md-4">
          <div class="form-container">
            ...
            <div class="tab-content mt-3">
              <div id="signIn">
                <form method="POST" action="./auth_in.php">
                  <div class="form-group">
                    <label for="email" class="input-label">Email universitaire:</label>
                    <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="&#xf0e0;  email@insat.ucar.tn" required>
